package com.anilderinbay.retrofitkotlin.adapter
...
class RecyclerViewAdapter(private val cryptoList : ArrayList<CryptoModel>,private val listener : Listener) : RecyclerView.Adapter<RecyclerViewAdapter.RowHolder>() {
    ...
    interface Listener {
     ...
     private val colors : Array<String> = arrayOf("#edc9f4","#f8e4a8","#3bbfbf","#acbdb6","#75b531","#f2ca52","#856c53","#cdb7b5","#faf0e6","#7ba769")
